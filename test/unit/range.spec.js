...
define([
    ...
    return function () {
        ...
        test('rng.insertNode', function () {
            ...
            equalsToUpperCase($cont.html(), '<p><b>bo</b><u>u</u><b>ld</b></p>',
                'rng.insertNode with inline should not split paragraph.');
        });
        ...
        test('rng.deleteContents', function () {
            ...
            equalsToUpperCase($cont.html(), '<p><b>bd</b><u>u</u></p>',
                'rng.deleteContents on partial text should remove only text');
            ...
            equalsToUpperCase($cont.html(), '<p><b></b><u>u</u></p>',
